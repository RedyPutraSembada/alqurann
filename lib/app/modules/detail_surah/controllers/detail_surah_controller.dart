...
class DetailSurahController extends GetxController {
  ...
  Future<void> addBookmark(
    ...
    if (lastRead == true) {
      ...
      List checkData = await db.query("bookmark",
          ...
          where:
              "surah = '${surah.name.transliteration.id.replaceAll("'", "+")}' and number_surah = ${surah.number} and ayat = ${ayat.number.inSurah} and juz = ${ayat.meta.juz} and via = 'surah' and index_ayat = $index and last_read = 0");
  ...
  Future<SurahDetail> getDetailSurah(String id) async {
    Uri url = Uri.parse("https://my-repo-alquran.vercel.app/surah/$id");
